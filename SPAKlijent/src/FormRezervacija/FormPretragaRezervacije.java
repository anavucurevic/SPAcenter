 ...
 * @author Ana
 */
public class FormPretragaRezervacije extends javax.swing.JDialog {

    public FormPretragaRezervacije(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelRezervacije) tblKlijenti.getModel()).setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        int row = tblKlijenti.getSelectedRow();
        if (row >= 0) {
            Rezervacija r = ((TableModelRezervacije) tblKlijenti.getModel()).getSelectedRezervacija(row);
            new FormDetaljiRezervacije(this, rootPaneCheckingEnabled, r).setVisible(true);
        }
    ...
    void refreshTable() {
        TableModelRezervacije tm = (TableModelRezervacije) tblKlijenti.getModel();
        tm.refreshTable();
    }
